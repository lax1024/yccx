 ...
 */
class StoreCharging extends AdminBase
{
    protected $store_model;
    protected $store_admin_model;

    protected function _initialize()
    {
        parent::_initialize();
        $this->store_model = new StoreChargingModel();
        $this->store_admin_model = new StoreModel();
    }
    ...
    {
        $map['store_pid'] = 0;
        $store_site_list = $this->store_admin_model->getChildList($map);
