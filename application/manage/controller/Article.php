...
class Article extends AdminBase
{
    ...
    public function index($cid = 0, $keyword = '', $page = 1)
    {
        ...
        $page_config = ['page' => $page, 'query' => ['cid' => $cid, 'keyword' => $keyword]];
        $article_list = $this->article_model->field($field)->where($map)->order(['publish_time' => 'DESC'])->paginate(15, false, $page_config);
