 ...
 */
class OrderService extends AdminBase
{
    ...
    public function index($keyword = '', $page = 1, $order_status = '')
    {
        ...
        $order_list = $this->order_model->getPageList($map, ' id DESC ', $page_config, 15, $this->web_info['is_super_admin'], $this->web_info['store_key_id'],true);
