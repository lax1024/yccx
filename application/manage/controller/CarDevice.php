 ...
 */
class CarDevice extends AdminBase
{
    ...
    public function index($keyword = '', $page = 1)
    {
        ...
        $cardevice_list = $this->car_device_tool->getPageList($keyword, 'DESC', $page_config, 15);
        ...
        return $this->fetch('index', ['cardevice_list' => $cardevice_list, 'device_status' => $device_status, 'device_type' => $device_type, 'terminal_car_type' => $terminal_car_type, 'terminal_time_code' => $terminal_time_code, 'keyword' => $keyword]);
    }
