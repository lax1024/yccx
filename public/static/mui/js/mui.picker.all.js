...
(function ($, document) {
    ...
    <div class="mui-dtpicker-header" style="background: #ffd31c;height: 45px">\
        <div data-id="btn-cancel" style="height: 100%;width: auto;float: left;color: #000000;font-size: 20px;line-height: 30px;padding-left: 5px">取消</div>\
        <span class="mui-dtpicker-title" style="position: absolute;left: 37%;padding: 6px;font-size: 22px;color: #ffffff;"></span>\
        <div data-id="btn-ok" style="width:auto;height:100%;float: right;color: #000000;font-size: 20px;line-height: 30px;padding-right: 5px">确定</div>\
    </div>\
     <div class="mui-dtpicker-body">\
        <div data-id="picker-y" class="mui-picker" style="background: #FFFFFF">\
            <div class="mui-picker-inner">\
                <div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
                <ul class="mui-pciker-list">\
                </ul>\
      ...
      <span style="width: auto;position: absolute;left: 20%;top: 45%;">年</span>\
      <div data-id="picker-m" class="mui-picker" style="background: #FFFFFF">\
<div class="mui-picker-inner">\
<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
<ul class="mui-pciker-list">\
</ul>\
...
<div style="width: auto;position: absolute;left: 45%;top: 45%;">月</div>\
<div data-id="picker-d" class="mui-picker" style="background: #FFFFFF">\
<div class="mui-picker-inner">\
<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
<ul class="mui-pciker-list">\
</ul>\
...
<div style="width: auto;position: absolute;left: 70%;top: 45%;">日</div>\
<div data-id="picker-h" class="mui-picker" style="background: #FFFFFF;border-left: none">\
<div class="mui-picker-inner">\
<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
<ul class="mui-pciker-list">\
</ul>\
...
<div style="width: auto;position: absolute;left: 93%;top: 45%;">时</div>\
<div data-id="picker-i" class="mui-picker" style="background: #FFFFFF">\
<div class="mui-picker-inner">\
<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
<ul class="mui-pciker-list">\
</ul>\
