...
function addStoreMarker(data) {
    for (var i = 0; i < data.length; i++) {
        ...
        var myIcon;
        myIcon = new BMap.Icon("http://img.youchedongli.cn/public/static/mobile/images/point_take_car_max.png?rand=20666&x-oss-process=image/resize,h_300", new BMap.Size(30, 40), {imageSize: new BMap.Size(30, 40)});
...
$("#js_choose_this_store").on("click", function () {
    ...
    var slat = $("#js_pop_store_take").attr("data-store-lat");
    var slng = $("#js_pop_store_take").attr("data-store-lng");
    localStorage.setItem("id_store_take_tradition",store_id+"");
    localStorage.setItem("name_store_take_tradition",store_name+"");
