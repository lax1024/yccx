$(document).ready(function () {
    ...
    //             var cityList = "<div class=\"index\" id=\"" + keyWord + "\">" + keyWord + "</div>\n" + "<div class=\"sub-list\">\n" +
    //                 "</div>";
    //             $("#city-main").append(cityList);
    //             //根据键来动态添加快捷键(界面上右侧边沿上的A-Z按钮)
    //             var key = "<li data-value=\"" + keyWord + "\"> <a href=\"#" + keyWord + "\">" + keyWord + "</a></li>";
    //             $("#city-key").append(key);
    //
    //             /**
    //              * json二级遍历
    ...
    //             localStorage.setItem("rcity", $(city_hot[i]).text());
    //             location.href = "area_returncar.html?rcity=" + $(city_hot[i]).text();
    //         } else {
    ...
    $(".js-city-item").on('click',function () {
        ...
        localStorage.setItem("rcity", $(this).text());
        localStorage.setItem('back_url_area_returncar','index');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.data, function (key, value) {
                    ...
                    var searchItem = $("<div class=\"js-city\" data-id=\"" + value.id + "\">" + value.name + "</div>");
