...
//自定义弹框 (类似于Android的Toast)
function ToastModel(title,msg ,duration) {
    duration = isNaN(duration) ? 3000 : duration;
    var toastDiv = document.createElement('div');
    toastDiv.style.cssText = "width:60%; min-width:150px; background:rgba(0,0,0,0.4); ; color:#fff; line-height:40px; text-align:center; border-radius:5px; position:fixed; top:61.8%; left:20%; z-index:999999; font-weight:bold;";

    document.body.appendChild(toastDiv);

    var titleDiv = document.createElement('div');
    titleDiv.innerHTML = title;
    titleDiv.style.cssText = "width: 100%;text-align: left;padding-left: 10px;font-size: 16px;";
    toastDiv.appendChild(titleDiv);

    var lineDiv = document.createElement('div');
    lineDiv.style.cssText = "width: 100%;border: #ffffff solid 1px;;";
    toastDiv.appendChild(lineDiv);

    var msgDiv = document.createElement('div');
    msgDiv.innerHTML = msg;
    msgDiv.style.cssText = "width: 100%;font-size: 15px;max-height: 200px;overflow-y: scroll";
