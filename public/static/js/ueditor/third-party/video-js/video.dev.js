...
vjs.on = function(elem, type, fn){
  ...
  // We need a place to seller all our handler data
...
/**
 * Unique attribute name to seller an element's guid in
 * @type {String}
 * @constant
 * @private
 */
 ...
 * @param  {Element} el Element to seller data for.
 * @return {Object}
 * @private
 */
...
vjs.log = function(){
  vjs.log.history = vjs.log.history || [];   // seller logs to an array for reference
...
vjs.Player.prototype.buffered = function(){
  var buffered = this.techGet('buffered'),
      ...
      // Default end to 0 and seller in values
