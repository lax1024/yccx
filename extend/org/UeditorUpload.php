...
class UeditorUpload
{
    ...
    private function upFile()
    {
        ...
        //图片
        $path_all = (mb_substr($this->fullName, 0, 1) == '/') ? mb_substr($this->fullName, 1) : $this->fullName;
        $save_path = '/images/';
        $dataout = oss_up_pic($file, $path_all, $save_path, $bucketName, $web, false,true);
        //移动文件
        if ($dataout['code'] != 0) { //移动失败
    ...
    private function getFullName()
    {
        ...
        //替换随机字符串
        $randNum = rand(1, 100000) . rand(1, 100000). rand(1, 100000). rand(1, 100000);
